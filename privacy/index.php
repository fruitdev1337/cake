    ...
    <div class="">
        <div class="title_box">
            ...
            <div class="privacy_page">
                ...
                <p>
                    Настоящая Политика конфиденциальности персональных данных (далее – Политика конфиденциальности) действует в отношении всей информации, которую Интернет-магазин «Название»,&nbsp; расположенный на доменном имени <a href="http://www.________________________________________________/"><span style="color: windowtext;">www</span><span style="color: windowtext;">.</span></a> адрес магазина, может получить о Пользователе во время использования сайта Интернет-магазина, программ и продуктов<i> </i>Интернет-магазина.
                </p>
                <p class="center">
                ...
                <p>
                    4.1.1. Идентификации Пользователя, зарегистрированного на сайте Интернет-магазина, для оформления заказа и (или) заключения Договора купли-продажи товара дистанционным способом с&nbsp; Название интернет-магазина.<sup></sup>
                </p>
                <p>
                ...
                <p>
                    9.3. Все предложения или вопросы по настоящей Политике конфиденциальности следует сообщать <i>(указать раздел сайта интернет-магазина)</i><sup></sup>
                </p>
                <p>
                    9.4. Действующая Политика конфиденциальности размещена на странице по адресу www… <i>(адрес магазина)</i>.
                </p>
                <p>
                    &nbsp;
                </p>
                <p>
                    Обновлено ______<i>(день, месяц, год)</i>
                </p>
            </div>
            <?
