...
<div id="favour__list" class="product__list favour__list row" data-entity="<?=$containerName?>">
    <?
    ...
    if (!empty($arResult['ITEMS']))
    {
        ...
        foreach ($arResult['ITEMS'] as $rowData)
        {
            ...
            <div class="favour-item product-card col-lg-3">
                <div class="favour-del close-btn" data-id="<?=$rowData['ID'];?>" title="<?=GetMessage('DELETE_FAVOUR')?>"></div>
