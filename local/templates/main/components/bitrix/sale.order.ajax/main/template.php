...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" class="bx-soa-wrapper mb-4<?=$themeClass?>" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="col-lg-8 col-12 bx-soa">
				<div id="bx-soa-main-notifications">
					<div class="alert alert-danger" style="display:none"></div>
					<div data-type="informer" style="display:none"></div>
                    <?if(CakeOrder::checkNotification()):?>
                    <div class="alert alert-success">
                        <div style="padding-left: 48px;">
                            <div class="icon-warning custom"></div>
                            <?=CakeOrder::checkNotification()?>
                        </div>
                    </div>
                    <?endif;?>
				</div>
				...
				<!--	REGION BLOCK	-->
				<div id="bx-soa-region" style="display: none" data-visited="false" class="bx-soa-section-hidden bx-active">
					<div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
						<div class="bx-soa-section-title" data-entity="section-title">
				...
				<!--	ORDER SAVE BLOCK	-->
				<div id="bx-soa-orderSave" class="mt-3">
					<div class="checkbox">
						<?
                        ...
                        <label class="main-user-consent-request">
                            <input id="agreement-box" type="checkbox" value="Y" name="">
                            <div class="main-user-consent-request-announce">Вы даете <a href="/privacy/" target="_blank">Согласие на обработку персональных данных</a> и принимаете условия <a href="/privacy/`" target="_blank">Пользовательского соглашения</a></div>
                        </label>
					</div>
					<a href="javascript:void(0)" style="margin: 10px 0" class="bx-soa-order-save pull-right btn-primary" data-save-button="true">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>
			...
			<!--	SIDEBAR BLOCK	-->
			<div id="bx-soa-total" class="col-lg-4 col-12 bx-soa-sidebar">
