...
$MESS["SOA_ORDER_SUC_TITLE"] = "Ваш заказ успешно создан!";
$MESS["SOA_ORDER_SUC"] = "Номер заказа: <b>№#ORDER_ID#</b>";
$MESS["SOA_DATE_SUC"] = "Дата оформления заказа: <b>#ORDER_DATE#</b>";
...
$MESS["PAYMENT_BLOCK_NAME_DEFAULT"] = "Оплата картой он-лайн";
...
$MESS["PRICE_DEFAULT"] = "Стоимость для каждого заказа";
