...
else
{
	if ($arParams['REFRESHED_COMPONENT_MODE'] === 'Y')
	{
		...
		?>
		<div class="bx-sap">
			<div class="bx-sap_wrapper" id="bx-sap<?=$wrapperId?>">
				<?
				if ($arParams['SELL_VALUES_FROM_VAR'] != 'Y')
				{
					...
					?>
						<div class="form-horizontal">
							<h3 class="my-2"><?=Loc::getMessage("SAP_SUM")?></h3>
				...
				else
				{
					...
					?>
					<div class="sale-accountpay-input-wrapper">
				...
				?>
				<div class="sale-accountpay-pp-wrapper">
						...
						<div class="row sale-accountpay-pp">
							...
							{
							?>
								<div class="sale-accountpay-pp-company col-sm-4 col-6 <?= ($key == 0) ? 'bx-selected' :""?>">
				...
				<div class="sale-account-pay-btn-wrapper">
						<a href="" class="btn-primary sale-account-pay-button"><?=Loc::getMessage("SAP_BUTTON")?></a>
				</div>
            </div>
		</div>
		<?
