		...
		<div class="title_box">
			...
			<div class="mb-3 mx-0">
				<div class="sale-order-detail-card">
					...
					<div class="mb-3">
						<div class="p-0">
<!--							<h3 class="order__title">--><?//= Loc::getMessage('SPOD_LIST_ORDER_INFO') ?><!--</h3>-->
							<div class="row order__info">
								<div class="col-sm mb-3">
									...
									<div class="sale-order-detail-more-links pt-3">
                                    ...
                                    <div class="row sale-order-detail-more-info-details" style="display: none;">
                                        <div class="col-12">
                                            <h4 class="sale-order-detail-more-info-details-title"><?= Loc::getMessage('SPOD_USER_INFORMATION') ?></h4>

                                            <div class="table-responsive">
                                                <table class="sale-order-detail-more-info-details-table">
                                                    <? if (strlen($arResult["USER"]["LOGIN"]) && !in_array("LOGIN", $arParams['HIDE_USER_INFO']))
                                                    {
                                                        ?>
                                                        <tr>
                                                            <th class="order__info-cell order__info-cell_title"><?= Loc::getMessage('SPOD_LOGIN')?>:</th>
                                                            <td class="order__info-cell"><?= htmlspecialcharsbx($arResult["USER"]["LOGIN"]) ?></td>
                                                        </tr>
                                                        <?
                                                    }
                                                    if (strlen($arResult["USER"]["EMAIL"]) && !in_array("EMAIL", $arParams['HIDE_USER_INFO']))
                                                    {
                                                        ?>
                                                        <tr>
                                                            <th class="order__info-cell order__info-cell_title"><?= Loc::getMessage('SPOD_EMAIL')?>:</th>
                                                            <td class="order__info-cell">
                                                    ...
                                                    if (strlen($arResult["USER"]["PERSON_TYPE_NAME"]) && !in_array("PERSON_TYPE_NAME", $arParams['HIDE_USER_INFO']))
                                                    {
                                                        ?>
                                                        <tr>
                                                            <th class="order__info-cell order__info-cell_title"><?= Loc::getMessage('SPOD_PERSON_TYPE_NAME') ?>:</th>
                                                            <td class="order__info-cell"><?= htmlspecialcharsbx($arResult["USER"]["PERSON_TYPE_NAME"]) ?></td>
                                                        </tr>
                                                        <?
                                                    }
                                                    if (isset($arResult["ORDER_PROPS"]))
                                                    {
                                                        foreach ($arResult["ORDER_PROPS"] as $property)
                                                        {
                                                            ?>
                                                            <tr>
                                                                <th class="order__info-cell order__info-cell_title"><?= htmlspecialcharsbx($property['NAME']) ?>:</th>
                                                                <td class="order__info-cell"><? if ($property["TYPE"] == "Y/N")
                                                                    {
								...
								{
									?>
									<div class="col btn-form__controls">
										<a href="<?=$arResult["URL_TO_COPY"]?>"
										   class="btn-primary"><?= Loc::getMessage('SPOD_ORDER_REPEAT') ?></a>
										<? if ($arResult["CAN_CANCEL"] === "Y")
										{
											?>
											<a href="<?=$arResult["URL_TO_CANCEL"]?>" class="btn-green-border"><?= Loc::getMessage('SPOD_ORDER_CANCEL') ?></a>
											<?
										}
										?>
									</div>
					...
					<div class="mb-3">
						<div class="col p-0">
							...
							<div class="row pb-3 m-0 align-items-center">
								<div class="col-2 col-2 d-none d-sm-block sale-order-detail-section-payment-image"></div>
									...
									<div class="col sale-order-detail-payment-options-methods-container">
										<div class="row payment-options-methods-row">
											<div class="col sale-order-detail-payment-options-methods">
												<div class="row m-0 align-items-start sale-order-detail-payment-options-methods-information-block">
													<div class="col-2 d-none d-sm-block sale-order-detail-payment-options-methods-image-container">
													...
													<div class="col-10 sale-order-detail-payment-options-methods-info">
													...
													{
														?>
														<div class="col-12 sale-order-detail-payment-options-methods-button-container">
															...
															else
															{
																...
																{
																	?>
																	<button class="btn btn-primary disabled"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></button>
																	<?
																}
																else
																{
																	?>
																	<button class="btn btn-primary active-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></button>
																	<?
																}
															}
															?>
									...
									<div class="row mb-3">
										<div class="col sale-order-detail-payment-options-shipment">
											<div class="row">
												...
												{
													?>
													<div class="col-2 d-none d-sm-block sale-order-detail-payment-options-shipment-image-container">
												...
												<div class="col-10 sale-order-detail-payment-options-methods-shipment-list">
													...
													<div style="display: none;" class="mt-3 mb-2 sale-order-detail-payment-options-methods-shipment-list-item-link">
											...
											<div class="sale-order-detail-payment-options-shipment-composition-map" style="display: none;">
												<div class="col">
					...
					<div class="mb-3">
						<div class="col p-0">
							<h3 class="sale-order-detail-section-title my-0"><?= Loc::getMessage('SPOD_ORDER_BASKET')?></h3>

							<div class="mx-0">
								<div class="col p-0">
									<div class="table-responsive sale-order-detail-goods-list-table-wrapper">
										<div class="sale-order-detail-goods-list-table">
											<div class="sale-order-detail-goods-list-table-head">
											<div class="sale-order-detail-goods-list-table-tr">
												<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-name"><?= Loc::getMessage('SPOD_NAME')?></div>
												<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-item-price"><?= Loc::getMessage('SPOD_PRICE')?></div>
												<?
												if (strlen($arResult["SHOW_DISCOUNT_TAB"]))
												{
													?>
													<div class="sale-order-detail-goods-list-table-td"><?= Loc::getMessage('SPOD_DISCOUNT') ?></div>
													<?
												}
												?>
												<div class="sale-order-detail-goods-list-table-td"><?= Loc::getMessage('SPOD_QUANTITY')?></div>
												<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-item-price"><?= Loc::getMessage('SPOD_ORDER_PRICE')?></div>
											</div>
											</div>
											<div class="sale-order-detail-goods-list-table-body">
											<?
											foreach ($arResult['BASKET'] as $basketItem)
											{
												?>
												<div class="sale-order-detail-goods-list-table-tr">
													<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-item-img-name">
                                                        ...
                                                        <div class="sale-order-detail-order-item-name" style="min-width: 250px;">
                                                            <a class="sale-order-detail-order-item-title"
													...
													<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-item-price">
													...
													{
														?>
														<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-item-properties text-right">
													...
													?>
													<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-item-properties">
														<?=$basketItem['QUANTITY']?>&nbsp;
														<?
													...
													<div class="sale-order-detail-goods-list-table-td sale-order-detail-order-item-price text-right">
					...
					<div class="row m-0 sale-order-detail-total-payment">
						<div class="col p-0 sale-order-detail-total-payment-container">
							<div class="row">
								<ul class="col-8 col sale-order-detail-total-payment-list-left">
								...
								<ul class="col-4 col sale-order-detail-total-payment-list-right">
									<?
									if (floatval($arResult["ORDER_WEIGHT"])) { ?>
