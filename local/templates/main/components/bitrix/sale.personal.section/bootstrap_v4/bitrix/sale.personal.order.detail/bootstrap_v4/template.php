...
foreach ($arResult["ORDER_PROPS"] as $o_props){
    if($o_props['ID'] == 7){
        $dely_address = $o_props['VALUE'];
    }
}
$order_props = CakeOrder::getOrderProps($arResult['ID']);
...
else
{
	...
	<div class="sale-order-detail">
			...
			<div class="mb-3">
                <p class="sale-order-detail-card">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <? if ($arParams['GUEST_MODE'] !== 'Y' && $show_links = false) // убираем ссылки !-----------------------
                                {
                                    ?>
                                    <div class="col-sm-auto mb-3 text-center">
                                        <a href="<?=$arResult["URL_TO_COPY"]?>"
                                           class="btn-primary btn-sm my-1 d-inline-block"><?= Loc::getMessage('SPOD_ORDER_REPEAT') ?></a>
                                        <? if ($arResult["CAN_CANCEL"] === "Y")
                                        {
                                            ?>
                                            <a href="<?=$arResult["URL_TO_CANCEL"]?>" class="btn-green-border btn-sm my-1 d-inline-block"><?= Loc::getMessage('SPOD_ORDER_CANCEL') ?></a>
                                            <?
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="col-sm-auto mb-3 text-center">
                                    <a href="/vozvrat/"
                                       class="btn-green-border btn-sm my-1 d-inline-block"><?= Loc::getMessage('ORDER_RETURN') ?></a>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <?/*<div class="row pb-3 align-items-center">
                                <div class="col-lg-1 col-md-2 col-2 d-none d-sm-block sale-order-detail-section-payment-image"></div>
                                <div class="col">
...
//                                                                echo htmlspecialcharsbx($paymentSubTitle);
                                                               echo Loc::getMessage('SPOD_SUB_ORDER_TITLE', array(
                                                                    "#ACCOUNT_NUMBER#" => htmlspecialcharsbx($arResult["ACCOUNT_NUMBER"]),
                                                                    "#DATE_ORDER_CREATE#" => $arResult["DATE_INSERT_FORMATED"]
                                                                )) ?>
                                                                <?
                                                        ...
                                                        <div class="mb-2 sale-order-detail-payment-options-methods-info-total-price">
                                                            <span class="sale-order-detail-sum-name"><?= Loc::getMessage('SPOD_ORDER_PRICE_BILL_CUSTOM')?>:</span>
                                                        ...
                                                        if (
                                                            ...
                                                            && $show_change = false // Убираем ссылку смены оплаты !--------------------------
                                                        )
                                                        {
                                                            ?>
                                                    ...
                                                    if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
                                                    {
                                                        ...
                                                        <div class="col-sm-auto col-12 sale-order-detail-payment-options-methods-button-container">
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                {
                                                                    ?>
                                                                    <button class="btn btn-primary btn-sm active-button js-m-pay"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></button>
                                                                    <?
                                                                }
                                                            }
                                                            ?>
                                        ...
                                        <div class="col sale-order-detail-payment-options-shipment">
                                            <div class="row">
                                                ...
                                                <div class="col sale-order-detail-payment-options-methods-shipment-list">
                                                    ...
                                                    <?if($dely_address && $shipment['PRICE_DELIVERY'] > 0):?>
                                                        <div class="mb-2 sale-order-detail-payment-options-methods-shipment-list-item"><?= Loc::getMessage('SPOD_STORE_ADDRESS')?>: <?=$dely_address?></div>
                                                    <?endif;?>
...
<?*/?>
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <h3 class="sale-order-detail-section-title mb-0"><?= Loc::getMessage('SPOD_ORDER_BASKET')?></h3>
                    ...
                    <?if($order_props['CAKE_TEXT']['VALUE'][0]):?>
                    <p class="col sale-order-detail-section-comments"><?=$order_props['CAKE_TEXT']['NAME']?>: <?=htmlspecialcharsbx($order_props['CAKE_TEXT']['VALUE'][0])?></p>
                    <?endif;?>
                <?if($order_props['ADD_IMG']['VALUE'][0]):?>
                    <p class="col sale-order-detail-section-comments"><?=$order_props['ADD_IMG']['NAME']?>: <a href="<?=$order_props['ADD_IMG']['VALUE'][0]['SRC']?>" target="_blank"><?=$order_props['ADD_IMG']['VALUE'][0]['ORIGINAL_NAME']?></a></p>
                <?endif;?>
