...
$MESS["SPOL_TPL_EMPTY_CANCELED_ORDER"] = "У Вас нет отмененных заказов нет";
$MESS["SPOL_TPL_LINK_TO_CATALOG"] = "Перейти в каталог";
$MESS["SPOL_TPL_VIEW_ALL_ORDERS"] = "Все заказы";
$MESS["SPOL_TPL_VIEW_ORDERS_HISTORY"] = "История заказов";
$MESS["SPOL_TPL_VIEW_ORDERS_CANCELED"] = "Отмененные заказы";
$MESS["SPOL_TPL_ORDERS_CANCELED_HEADER"] = "Отмененные заказы";
$MESS["SPOL_TPL_CUR_ORDERS"] = "Текущие заказы";
