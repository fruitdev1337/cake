							...
							<div class="col sale-order-list-inner-row-body">
								<div class="row">
									<div class="col sale-order-list-payment">
                                        ...
                                        <?
                                        //TODO Неплохо бы объеденить это и использовать как шаблон еще и в оплате без регистрации /personal/pay/index.php
                                        ...
                                        if($order['SHIPMENT'][0]['DELIVERY_ID'] == 3){
                                            ...
                                            $delivery_cost = ' '.CurrencyFormat($order['SHIPMENT'][0]['PRICE_DELIVERY'], $order['SHIPMENT'][0]['CURRENCY'] ? $order['SHIPMENT'][0]['CURRENCY'] : 'RUB');
                                        }
...
<!--                                                <div>ежедневно 9:00 – 21:00</div>-->
                                ...
                                <div class="row pb-3 sale-order-list-inner-row">
                                    <div class="col-12 col-sm-6 sale-order-list-about-container mb-sm-0 mb-2 text-sm-left text-center">
                                        <p><span><?=Loc::getMessage('SPOL_TPL_SUM_TO_PAID')?>:</span> <span><?=$payment['FORMATED_SUM']?></span></p>
                                    </div>
                                    <?
