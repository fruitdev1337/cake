			...
			<div class="bx_subscribe_response_container">
				<table>
					<tr>
						...
						<td>
							<div style="font-size: 22px;font-weight: bold;margin-bottom: 10px;"><?=GetMessage('subscr_form_response_'.$arResult['MESSAGE']['TYPE'])?></div>
            ...
            <div class="subform-col col-auto pl-0">
                <div class="bx_subscribe_submit_container">
                    <button class="sender-btn btn-subscribe" id="bx_subscribe_btn_<?=$buttonId?>">
                        <span class="d-sm-inline-block d-none"><?=GetMessage("subscr_form_button")?></span>
