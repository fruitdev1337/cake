...
<?if($arParams['PRODUCT_PROPERTY'] && $ElementID && $arParams['CATALOG_IBLOCK_ID']):?>
    ...
    if($arParamsElm[$ElementID]['PROPERTIES'][$arParams['PRODUCT_PROPERTY']]["VALUE"]):
        ...
        <div class="slider_wrapper">
            <div class="title_box">
                <h2><?=Loc::getMessage('K_PRODUCTS_RECEIPT_TITLE');?></h2>
            </div>
            <div class="slider main-slider">
                <?
                $GLOBALS['arFilterProd'] = array(
...
<div class="link-back mt-5">
    <a class="link-green-border" href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>">
        <span class="fa fa-angle-left"></span>
        <span style="margin-left: 3px;"><?=GetMessage("T_NEWS_DETAIL_BACK")?></span>
    </a>
</div>
