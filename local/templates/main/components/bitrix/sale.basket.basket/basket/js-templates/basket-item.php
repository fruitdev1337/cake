...
<script id="basket-item-template" type="text/html">
    <tbody class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
			...
			<td class="basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-info">
						...
						{
							?>
							<span class="basket-item-actions-remove" style="display: none;" data-entity="basket-item-delete"></span>
							<?
						}
						?>
        ...
        <td class="custom_add">
            <div class="form  form--cart">
                <div class="form-group">
                    <input type="text" class="form-control js-cust-field js-text-f" data-id="{{ID}}" placeholder="Ваш текст">
                </div>
                <div class="form-group">
                    <div class="fileform">
                        <div id="fileformlabel"></div>
                        <div class="selectbutton">
                            <img src="/local/templates/main/img/paper-clip.svg" alt="">
                            <span>Прикрепить файл</span>
                        </div>
                        <input type="file" name="upload" class="upload-image js-cust-field js-upload-f" data-id="{{ID}}" onchange="getName(this, this.value);">
                    </div>
                </div>
            </div>
        </td>
