;(function() {
	...
	BX.Sale.BasketComponent = {
		...
		initializeBasketItems: function()
		{
			...
			if (BX.Sale.BasketComponent.params.MIN_PRICE > 0)
			{
				if (BX.Sale.BasketComponent.result.allSum < BX.Sale.BasketComponent.params.MIN_PRICE)
				{
					this.result.TOTAL_RENDER_DATA['BUY_BTN'] = 'disabled';
					this.result.TOTAL_RENDER_DATA['BUY_BTN_TEXT'] = BX.Sale.BasketComponent.params.MIN_PRICE_ORDER_BUTTON_ERROR;
				}
				else
				{
					this.result.TOTAL_RENDER_DATA['BUY_BTN'] = '';
					this.result.TOTAL_RENDER_DATA['BUY_BTN_TEXT'] = '';
				}
			}
