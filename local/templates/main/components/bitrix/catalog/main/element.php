...
if($_GET['ajax_view'] == 'y')
{
    ...
    <script src="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog/main/bitrix/catalog.element/bootstrap_v4/script.js"></script>
    <script src="<?=SITE_TEMPLATE_PATH?>/js/fast_view.js"></script>
    <link href="<?=SITE_TEMPLATE_PATH?>/components/bitrix/catalog.element/fast_bootstrap/style.css" rel="stylesheet">
    ...
    <div class="product_card_detail">
        ...
        $componentElementParams = array(
            ...
            "DETAIL_PRODUCT_COMPOSITION" => $arParams["DETAIL_PRODUCT_COMPOSITION"],
            "DETAIL_ENERGY_VALUE" => $arParams["DETAIL_ENERGY_VALUE"],
            "DETAIL_PROTEIN" => $arParams["DETAIL_PROTEIN"],
            "DETAIL_FAT" => $arParams["DETAIL_FAT"],
            "DETAIL_CARB" => $arParams["DETAIL_CARB"],
            "DETAIL_ENERGY_VALUE_PERCENT" => $arParams["DETAIL_ENERGY_VALUE_PERCENT"],
            "DETAIL_PROTEIN_PERCENT" => $arParams["DETAIL_PROTEIN_PERCENT"],
            "DETAIL_FAT_PERCENT" => $arParams["DETAIL_FAT_PERCENT"],
            "DETAIL_CARB_PERCENT" => $arParams["DETAIL_CARB_PERCENT"],
