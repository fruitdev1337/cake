...
else
{
    ...
    <div class="search-page row no-gutters" id="search-list">
    <div class="title_box col order-1"><h1><?=$APPLICATION->ShowTitle(false);?></h1></div>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PAGE_ELEMENT_COUNT" => $arParams["SEARCH_PAGE_RESULT_COUNT"],
