...
$arAllPropList = array();
$arListPropList = $defaultValue;
$arHighloadPropList = $defaultValue;
...
$arTemplateParameters['DETAIL_PRODUCT_COMPOSITION'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_PRODUCT_COMPOSITION'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_ENERGY_VALUE'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_ENERGY_VALUE'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_PROTEIN'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_PROTEIN'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_FAT'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_FAT'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_CARB'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_CARB'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_ENERGY_VALUE_PERCENT'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_ENERGY_VALUE_PERCENT'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_PROTEIN_PERCENT'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_PROTEIN_PERCENT'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_FAT_PERCENT'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_FAT_PERCENT'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);

$arTemplateParameters['DETAIL_CARB_PERCENT'] = array(
    'PARENT' => 'DETAIL_SETTINGS',
    'NAME' => GetMessage('K_PROPERT_CARB_PERCENT'),
    'TYPE' => 'LIST',
    'VALUES' => $arAllPropList
);
...
// region custom catalog cart min price
$arTemplateParameters['MESS_MIN_PRICE_TITLE'] = array(
    'PARENT' => 'BASKET',
    'NAME' => GetMessage('K_MESS_MIN_PRICE_TITLE'),
    'TYPE' => 'INTEGER',
    'DEFAULT' => GetMessage('K_MESS_MIN_PRICE_TITLE_DEFAULT')
);
$arTemplateParameters['PATH_TO_DELIVERY'] = array(
    'PARENT' => 'BASKET',
    'NAME' => GetMessage('K_MESS_DELIVERY_TITLE'),
    'TYPE' => 'STRING',
    'DEFAULT' => SITE_DIR.'delivery_and_pay/'
);
// endregion
...
{
    if (ModuleManager::isModuleInstalled("blog") || true)
    {
...
if($arCurrentValues['IBLOCK_ID'])
{
    ...
    while($arRes = $rsData->Fetch())
    {
        ...
        {
            $arPropAction[$arRes['FIELD_NAME']] = $arRes['EDIT_FORM_LABEL']?$arRes['EDIT_FORM_LABEL']:$arRes['FIELD_NAME'];
        }
    }
    ...
    $arTemplateParameters['ACTION_SECTION'] = array(
        "NAME" => GetMessage("ACTION_SECTION_PROP"),
        "TYPE" => "LIST",
        "VALUES" => $arPropAction,
        "PARENT" => "SECTIONS_SETTINGS"
    );
