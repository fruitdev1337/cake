...
$filter_box = 'bx-filter-box-'.$this->randString()
?>
<div class="title">
			...
			<div class="row">
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
						<div class="filter-price-block <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="<?=$adClass?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
						<span class="bx-filter-container-modef"></span>
						...
						<div class="bx-filter-block" data-role="bx_filter_block" data-id="<?=$filter_box?>">
							<div class="row bx-filter-parameters-box-container">
							<?
...
<!--													<span class="bx-filter-input-checkbox">-->
														...
														<span class="bx-filter-param-text" title="<?=$ar["VALUE"];?>">
                                                            <?=$ar["VALUE"];
                                                            if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                                ?> <span class="count_items" data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span><?
                                                            endif;?>
                                                        </span>
<!--													</span>-->
												</label>
			...
			<div class="bx-filter-parameters-box-container">
				...
				<div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
                    <div class="row m-0 align-items-center flex-nowrap justify-content-between">
                        <div><?echo GetMessage("CT_BCSF_FILTER_COUNT", array("#ELEMENT_COUNT#" => '<span id="modef_num">'.intval($arResult["ELEMENT_COUNT"]).'</span>'));?></div>
                        <span class="arrow"></span>
                        <a class="btn-primary" href="<?echo $arResult["FILTER_URL"]?>" target=""><?echo GetMessage("CT_BCSF_FILTER_SHOW")?></a>
                    </div>
				</div>
			</div>
		</form>
