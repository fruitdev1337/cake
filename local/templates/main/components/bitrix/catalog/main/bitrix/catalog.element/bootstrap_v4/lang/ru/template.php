...
$MESS['K_CHOISE'] = "Выберите";
$MESS['K_SALE_GOODS'] = "Товары по акции";

$MESS['MESS_READY_TIME'] = "Торт будет готов не ранее <span>#TIME#</span>";
$MESS['MESS_PRODUCTION_TIME'] = "Срок изготовления:";
$MESS['MESS_APPLY_TEXT'] = "На этот торт Вы можете нанести надпись или свою картинку без изменения стоимости. Просто заполните соответствующие поля в корзине при оформлении заказа.";
?>