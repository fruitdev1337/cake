...
$MESS['K_MORE_PRODUCT_2'] = "Похожие товары";
$MESS['K_MORE_BUY_TITLE'] = "C этим товаром покупают";
$MESS['K_ENERGY_VALUE_TITLE'] = "Калории";
$MESS['K_PROTEIN_TITLE'] = "Белки";
$MESS['K_FAT_TITLE'] = "Жиры";
$MESS['K_CARB_TITLE'] = "Углеводы";
$MESS['K_ENERGY_KBZHU_TITLE'] = "Пищевая ценность на 100 грамм (% от суточной нормы)";
$MESS['K_RATING_TITLE'] = "Рейтинг";
$MESS['K_QUANTITY_TITLE'] = "Нет в наличии";
$MESS['K_INFO_TITLE'] = "Общая информация";
$MESS['K_DESCRIPTION_TITLE'] = "Описание";
$MESS['K_GOTO_GOOD'] = "На страницу товара";
$MESS['K_MAKE_CHOICE'] = "Выберите";
