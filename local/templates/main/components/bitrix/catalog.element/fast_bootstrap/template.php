...
<div class="bx-catalog-element<?=$themeClass?> product_item__cart-<?=isset($arResult['JS_OFFERS'][0])?$arResult['JS_OFFERS'][0]['ID']:$arResult['ID']?>" id="<?=$itemIds['ID']?>" itemscope itemtype="http://schema.org/Product">
    ...
    <div class="product-detail-info-top row">
        <div class="col-12">
            <div class="product_card__title">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a class="link-green-border" style="font-size: 14px;"
                           href="<?=$arResult['DETAIL_PAGE_URL']?>"><?=GetMessage('K_GOTO_GOOD')?> <span class="fa fa-angle-right"></span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        ?>
        <div class="product-item-detail-main-info col-md-6">
                    ...
                    <div class="product-detail-sku-container" id="<?=$itemIds['TREE_ID']?>">
                        ...
                        foreach ($arResult['SKU_PROPS'] as $skuProperty)
                        {
                            ...
                            <div data-entity="sku-line-block" class="sku-line-block">
                                <div class="product-item-scu-container-title mb-2"><?=GetMessage('K_MAKE_CHOICE')?> <?=strtolower(htmlspecialcharsEx($skuProperty['NAME']))?>:</div>
                        ...
                        foreach ($arResult['DISPLAY_PROPERTIES'] as $property)
                        {
                            ...
                            <li class="product-item-detail-properties-item col-12">
                                <div class="properties-item row no-gutters">
                                    <span class="product-item-detail-properties-name col-lg-6"><?=$property['NAME']?></span>
                                    <span class="product-item-detail-properties-value col-lg-6"><?=(
    ...
    <div style="display: none;" class="product-item-detail-tabs">
            ...
            <ul class="nav nav-tabs product-item-detail-tabs-list" role="tablist">
                ...
                <li class="nav-item product-item-detail-tab" data-entity="tab">
                    <a class="nav-link active product-item-detail-tab-link"
                       id="description-tab" data-toggle="tab" href="#description_<?=$itemIds['TABS_ID']?>" role="tab" aria-controls="description" aria-selected="true">
                ...
                <li class="nav-item product-item-detail-tab" data-entity="tab">
                    <a class="nav-link product-item-detail-tab-link"
                       id="comments-tab" data-toggle="tab" href="#comments_<?=$itemIds['TABS_ID']?>" role="tab" aria-controls="comments" aria-selected="false">
        ...
        <div class="tab-content product-item-detail-tabs-content" id="<?=$itemIds['TAB_CONTAINERS_ID']?>">
            ...
            {
            ?>
            <div class="tab-pane product-item-detail-tab-content active" id="description_<?=$itemIds['TABS_ID']?>" role="tabpanel" aria-labelledby="description-tab" itemprop="description">
                <?if ($showDescription):?>
            ...
            {
            ?>
            <div class="tab-pane product-item-detail-tab-content" id="comments_<?=$itemIds['TABS_ID']?>" role="tabpanel" aria-labelledby="comments-tab">
